...
function render(){
 if(state.screen==='splash')return shell(`<img class="brand-mark splash-mark" src="assets/pride-bank.svg" alt="Pride"><div class="brand">PRIDE</div>`,'splash');
 if(state.screen==='welcome')return shell(`<img class="brand-mark welcome-mark" src="assets/pride-bank.svg" alt="Pride"><h1 class="title">Welcome to Pride</h1><p class="copy">Create, explore and participate using Blocks.</p><div class="spacer"></div><button class="primary" data-go="identity">Get started</button>`,'welcome');
...
function topbar(){return `<header class="topbar"><img class="brand-mark header-mark" src="assets/pride-bank.svg" alt="Pride"><div><div class="hello">Good evening</div><div class="name">${esc(name())}</div></div><div class="spacer"></div><div class="avatar" aria-label="${esc(name())}">${esc(initials(name()))}</div></header>`;}
